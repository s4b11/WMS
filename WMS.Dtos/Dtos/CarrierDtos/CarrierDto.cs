...
namespace WMS.Dtos
{
    public class CarrierDto : EntityGuidDto
    {
    ...
    public class CarrierCreateDto : EntityGuidDto
    {
        public required string Name { get; set; }
        public required string Type { get; set; }
        public required string Addr1 { get; set; }
    ...
    public class CarrierEditDto : EntityGuidDto
    {
        public required string Name { get; set; }
        public required string Type { get; set; }
        public required string Addr1 { get; set; }
    ...
    public class CarrierCompactDto : EntityGuidDto
    {
        public required string Name { get; set; }
        public required string Type { get; set; }
        public required string City { get; set; }
